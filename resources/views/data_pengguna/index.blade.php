                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title ">DATA PENGGUNA
                            {{-- <a href="{{ route('datapengguna.create') }}" class="btn btn-primary float-right"> Tambah Data</a> --}}
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    @foreach ($pengguna as $key)
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-around">
                                                ...
                                                <form action="{{route('datapengguna.destroy',$key->id)}}" method="post" onsubmit="return confirm('yakin hapus data?') ">
                                                    @csrf
                                                    @method('delete')
